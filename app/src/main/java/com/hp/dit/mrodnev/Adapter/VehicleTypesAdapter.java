...
public class VehicleTypesAdapter extends ArrayAdapter<VehicleType> {
    // Your sent context
    private Context context;
    // Your custom values for the spinner (User)
    private List<VehicleType> values;

    public VehicleTypesAdapter(Context context, int textViewResourceId, List<VehicleType> values) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        label.setText(values.get(position).getVehicleName());
